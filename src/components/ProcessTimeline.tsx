        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 relative">
          {steps.map((st, idx) => {
            ...
            return (
              <div
                key={idx}
                className="glass-panel glass-panel-hover p-6 rounded-2xl border border-slate-200 relative group overflow-hidden flex flex-col justify-between"
              >
                {/* Step Number Badge */}
                ...
                <div className="mb-4">
                  <div className="w-12 h-12 rounded-xl bg-slate-50 border border-slate-200 flex items-center justify-center mb-4 group-hover:border-amber-400 transition-colors shadow-md">
