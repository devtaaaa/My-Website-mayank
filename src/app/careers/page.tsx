    ...
    <main className="min-h-screen bg-transparent text-slate-900 relative pt-24 sm:pt-32 pb-24">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          <div className="inline-flex items-center space-x-2 px-3 py-1 rounded-full bg-slate-100 border border-slate-200 text-emerald-400 text-xs font-mono uppercase tracking-widest mb-4">
        ...
        <div className="grid lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-7 space-y-6">
            <h2 className="text-2xl font-bold text-slate-900 uppercase tracking-wide flex items-center border-b border-slate-200 pb-4">
            ...
            <div className="space-y-4">
              {jobs.map((job, idx) => (
                <div key={idx} className="glass-panel p-6 rounded-xl border border-slate-200 hover:border-emerald-500/50 transition-colors group">
                  <div className="flex flex-col sm:flex-row justify-between sm:items-start mb-4">
                    <div>
                      <h3 className="text-xl font-bold text-slate-900 group-hover:text-emerald-400 transition-colors">
                        {job.title}
                      </h3>
                      <div className="flex flex-wrap items-center gap-3 mt-2 text-xs font-mono text-slate-500">
                        ...
                        <span className="flex items-center px-2 py-0.5 bg-slate-100 rounded border border-slate-200 text-emerald-400">Exp: {job.exp}</span>
                      </div>
                    </div>
          ...
          <div className="lg:col-span-5">
            <div className="sticky top-32 glass-panel p-8 rounded-2xl border border-slate-200/80 shadow-2xl bg-slate-50/80">
              ...
              <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
                <div>
                  <label className="block text-xs font-mono text-slate-500 uppercase mb-1.5">Full Name</label>
                  <input type="text" className="w-full bg-slate-100 border border-slate-200 rounded-lg px-4 py-3 text-slate-900 focus:outline-none focus:border-emerald-500 transition-colors" placeholder="e.g. Rahul Sharma" />
                </div>
                <div>
                  <label className="block text-xs font-mono text-slate-500 uppercase mb-1.5">Email Address</label>
                  <input type="email" className="w-full bg-slate-100 border border-slate-200 rounded-lg px-4 py-3 text-slate-900 focus:outline-none focus:border-emerald-500 transition-colors" placeholder="rahul@example.com" />
                </div>
                <div>
                  <label className="block text-xs font-mono text-slate-500 uppercase mb-1.5">Area of Expertise</label>
                  <select className="w-full bg-slate-100 border border-slate-200 rounded-lg px-4 py-3 text-slate-900 focus:outline-none focus:border-emerald-500 transition-colors appearance-none">
                ...
                <div className="pt-2">
                  <div className="w-full border-2 border-dashed border-slate-200 rounded-lg p-6 text-center hover:border-emerald-500 transition-colors cursor-pointer bg-slate-50/50">
                    <CheckCircle2 className="w-6 h-6 text-emerald-400 mx-auto mb-2" />
                    <div className="text-sm text-slate-900 font-medium">Click to upload Resume (PDF)</div>
